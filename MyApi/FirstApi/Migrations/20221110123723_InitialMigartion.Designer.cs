...
namespace FirstApi.Migrations
{
    ...
    [Migration("20221110123723_InitialMigartion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirstApi.Models.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FirstApi.Models.Domain.WalkDifficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FirstApi.Models.Domain.Walk", b =>
                {
                    b.HasOne("FirstApi.Models.Domain.Region", "Region")
                        .WithMany("Walks")
                        .HasForeignKey("RegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FirstApi.Models.Domain.WalkDifficulty", "WalkDifficulty")
                        .WithMany()
